...
type LoaderData = {
  accessPoint: Awaited<ReturnType<typeof getLoaderData>>;
};

function getLoaderData({ id, userId }: Pick<AccessPoint, "id"> & { userId: User["id"] }) {
...
export const loader: LoaderFunction = async ({ request, params }) => {
  ...
  const accessPoint = await getLoaderData({ id: Number(params.accessPointId), userId });
